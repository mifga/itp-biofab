;===============================================================
; GooPyGears / Adventurer 3 + Duet 3 Mini 5+ (AllStruder FRESH)
...
M550 P"GooPyGearsWiFi"         ; Printer name (AP SSID / hostname)

;-------------------------------
; Network (Standalone AP mode)
;-------------------------------
M551 P"g00000py"               ; Machine password (EDIT as needed)
